...
\end{figure}
The area of the union once again is not simply the sum of the areas. Instead we can reason out that when we add the three areas we include the area of $E \intersect G$, $G \intersect F$, and $F \intersect E$ twice each and $E \intersect G \intersect F$ three times. The sum of these doubly counted areas also includes the area $E \intersect G \intersect F$ three times. Thus, we can subtract the area of the doubly counted areas but this also subtracts the area of $E \intersect G \intersect F$ three times leaving this area unaccounted for. Therefore we then add the area of $E \intersect G \intersect F$ to find the complete area of $E \union G \union F$.
\begin{theorem}
