...
\begin{example}
    ...
    \par\smallskip
    First we find the probability that a single spider catches less than 4 flies in 2 hours. Let $X$ be the number of flies the spider catches in 2 hours. The average number of flies caught in 2 hours is $\avg = 4$. Thus, we have $X \dist \pois(4)$.
    \[
